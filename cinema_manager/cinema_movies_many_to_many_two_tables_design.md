# Cinema Manager Two Tables (Many-to-Many) Design Recipe Template
...
movies, movie title, movie release date , cinema, city name
```
...
```bash
psql -h 127.0.0.1 cinema_manager < movies_cinemas.sql
```
